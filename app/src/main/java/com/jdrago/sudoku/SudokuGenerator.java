...
// Adapted/pilfered from https://github.com/SomeKittens/Sudoku-Project
// They retain all credit/ownership for this generator.

// From the comments of the original code:
//
...
public class SudokuGenerator
{
    ...
    public int[][] nextBoard(Difficulty difficulty)
    {
        int holeCount;
        switch(difficulty) {
            case EASY:
